...
%                      [NoControlSoundField.dk{sridx}]=get_produced_x_signal(indata{sridx},obj.q_uncontrol,obj.irArray{mod(sridx,2)+1},obj.M1,obj.L,obj.K);
         ...
         function obtain_output(obj,indata)
            for sridx = 1:2
                %      filter_vast{sridx}=CG_o_total_over_ac(spaCorrMtxBr1{sridx},spaCorrMtxDk{sridx},spaCorrVecBr1{sridx},sigDistort1(sridx),round((L*J)/8),K_SET);
                if sridx==1
                    [obj.soundtrack{sridx}]=get_produced_x_signal_speaker(indata{sridx},obj.FILTER_COEFFS{sridx},obj.irArray{sridx},obj.M1,obj.L,obj.K);
%                     [ReprodSoundField.dk{sridx}]=get_produced_x_signal_speaker(indata{sridx},obj.FILTER_COEFFS{sridx},obj.irArray{mod(sridx,2)+1},obj.M2,obj.L,obj.K);
                    
%                     [NoControlSoundField.Br{sridx}]=get_produced_x_signal(indata{sridx},obj.q_uncontrol,obj.irArray{sridx},obj.M1,obj.L,obj.K);
%                     [NoControlSoundField.dk{sridx}]=get_produced_x_signal(indata{sridx},obj.q_uncontrol,obj.irArray{mod(sridx,2)+1},obj.M2,obj.L,obj.K);
                else
                     [obj.soundtrack{sridx}]=get_produced_x_signal_speaker(indata{sridx},obj.FILTER_COEFFS{sridx},obj.irArray{sridx},obj.M2,obj.L,obj.K);
%                     [ReprodSoundField.dk{sridx}]=get_produced_x_signal_speaker(indata{sridx},obj.FILTER_COEFFS{sridx},obj.irArray{mod(sridx,2)+1},obj.M1,obj.L,obj.K);
